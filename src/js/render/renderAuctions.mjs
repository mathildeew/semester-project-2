...
// ------ LOAD MORE BUTTON THAT DOESNT WORK
...
//       out += `
//                               <a class="auctionLinksss">
//                                   <div class="card h-100 bg-light  border-secondary">
//                                     <div class="overflow-hidden  d">
//                                       <img id="auctionsImg" class="card-img-top" src="${auctions[i].media[0]}"/>
//                                     </div>
//                                     <div class="card-body d-flex flex-column justify-content-between">
//                                     <div>
//                                       <h3 class="auctionCardTitle card-title">${auctions[i].title}</h3>
//                                       <p class="auctionCardSeller fw-light mb-2"></p>
//                                       <div class="d-flex mb-3">
//                                         <i class="bi bi-clock-fill me-1"></i>
//                                         <p class="auctionCardEnds mb-0"></p>
...
//   auctionCard.innerHTML = out;
//   auctionsContainer.append(auctionCard);

//   function loadData(auctions) {
//     let currentDisplayedItems = loadItems + 3;
...
//     if ((currentDisplayedItems = auctions.length)) {
